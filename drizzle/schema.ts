...
export const analyses = sqliteTable("analyses", {
  ...
  tryOnStatus: text("try_on_status").notNull().default("skipped"),
  tryOnCategory: text("try_on_category"),
  tryOnJobId: text("try_on_job_id"),
  tryOnProvider: text("try_on_provider"),
  tryOnError: text("try_on_error"),
  tryOnLatencyMs: integer("try_on_latency_ms"),
  tryOnStartedAt: text("try_on_started_at"),
